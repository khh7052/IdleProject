...
public class HUD : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        GameManager.Instance.MonsterCountChanged += OnMonsterCountChanged;
        ...
        OnMonsterCountChanged(GameManager.Instance.MonsterCount);
    }
    ...
    public void OnMonsterCountChanged(int count) => monsterCountText.text = $"Current Monster : {count}/{GameManager.Instance.MaxMonsterCount}";
